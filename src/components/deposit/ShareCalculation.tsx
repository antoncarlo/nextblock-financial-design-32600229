...
export function ShareCalculation({ mode, amount, totalAssets, totalSupply }: ShareCalculationProps) {
    ...
    return (
      <div className="rounded-lg bg-gray-50 p-3">
        ...
        <div className="mt-1.5 flex items-center justify-between">
          ...
          <span className="font-mono-num text-xs text-gray-600">1 share = ${sharePrice.toFixed(4)} USDC</span>
        </div>
      </div>
    );
  }
